  ...
  return (
    ...
    >
      ...
      <span className='prose'>
        <p></p>{remainingChars} characters remaining
      </span>

      <button
        className='flex items-center justify-center absolute right-0 px-2 py-1 font-medium h-8 bg-neutral-200 dark:bg-neutral-700 text-neutral-900 dark:text-neutral-100 rounded w-20'
        disabled={isMutating}
        type='submit'
      >< a className='prose'>log</a>
      </button>
    </form>
  );
}
